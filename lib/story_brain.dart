...
class StoryBrain
{
  ...
  {
    if(_storyNumber==3 || _storyNumber==4 || _storyNumber==5) {_storyNumber=0;}

    if(choiceNumber==1 && _storyNumber==0) {_storyNumber=2;}
    else if(choiceNumber==2 && _storyNumber==0) {_storyNumber=1;}
